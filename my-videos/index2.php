...
?>
	...
	<div class="col-lg-12">
		...
		<? if($data['firstname'] != '') { ?>
			<h2 style="padding-top: 50px">Hello <?=$data['firstname']?>! Welcome to Your Jump Gallery</h2>		
			
			<a href="http://<?=$_SERVER['HTTP_HOST'].WEBROOT.'/admin/download-all2.php?id='.$_GET['id'].'&code='.md5($_GET['id'].$_GET['email']);?>" class="btn btn-info" role="button">Download All Files</a>
